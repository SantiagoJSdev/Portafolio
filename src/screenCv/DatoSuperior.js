    ...
    return (
        <>
          ...
          <div className='container-cajaMail'>
                ...
                <div className='cajaMail-2'>
                    <i className="fas fa-phone"></i>
                    <div className='correo2'>+57 3007404102</div>
                </div>

                <div className='cajaMail-3'>
                    <i className="fas fa-map-marker-alt"></i>
                    <div className='correo3'>Bucaramanga, Colombia</div>
                </div>
